...
[![скриншот сайта](https://vallek.github.io/webdevtips/assets/webdevtips.webp)](https://vallek.github.io/webdevtips/)
...
* backend - для любых языков веб бэка.
...
А еще можете [поддержать меня на бусти](https://boosty.to/vallek)